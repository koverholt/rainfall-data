...
<main class="min-h-screen bg-gray-50">
  <nav class="border-gray-200 bg-[#a3cef1] dark:bg-gray-800 dark:border-gray-700">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <span class="self-center text-gray-800 text-2xl font-semibold whitespace-nowrap dark:text-white">
  ...
  <div class="text-xl text-gray-800 m-4 p-4 mt-2 -mb-1 ml-10">
    Showing rainfall from the
    <button id="dropdownSearchButton" data-dropdown-toggle="dropdownSearch" data-dropdown-placement="bottom" class="text-gray-800 bg-[#a3cef1] hover:bg-[#6096ba] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-1.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Marble Falls 4 WSW <svg class="w-4 h-4 ml-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
    <div id="dropdownSearch" class="z-10 hidden bg-white rounded-lg shadow w-60 dark:bg-gray-700">
        ...
        <ul class="h-96 px-3 pb-3 overflow-y-auto text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownSearchButton">
          {#each listOfSites as site}
            <li>
              <div class="flex items-center pl-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                  <label for="checkbox-item-12" class="w-full py-2 ml-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300">{site.location}</label>
                </div>
            </li>
          {/each}
        </ul>
  ...
  <section class="dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-2 lg:px-6">
        <div class="grid gap-8 mb-2 lg:mb-2 md:grid-cols-3">
            <div class="place-content-center items-center bg-[#a3cef1] rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <div class="p-5">
                <h3 class="text-center text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  {sinceMidnight} in
                </h3>
